...
public class tcuDetail extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.tcu_details);
    ...
    private void setupApplyButton() {
        ...
        applyButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // TCU application link from your document
                String applicationUrl = "https://tcu.edu.ph/tcu-online-application-for-freshmen-admission-for-incoming-first-year-college-academic-year-2025-2026";
